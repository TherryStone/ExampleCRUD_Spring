package com.truongtd.controller;
...
import com.truongtd.service.CountryService;
...
public class CountryController {
	...
	public String getCountries(Model model) {
		List<String> lstCoutries = countryService.getAllCountries();
		model.addAttribute("country", new Country());
		model.addAttribute("lstCoutries", lstCoutries);
	...
	@RequestMapping(value = "/updateCountry{/id}", method = RequestMethod.POST, headers = "Accept = application/json")
	public String updateCountry(@PathVariable("id") int id, Model model) {
		...
		model.addAttribute("lstCoutries", this.countryService.getAllCountries());
		return "countryDetails";
	}
